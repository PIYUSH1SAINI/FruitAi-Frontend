...
const FAQSection = () => {
  ...
  useEffect(() => {
    const fetchFaqs = async () => {
      try {
        const response = await fetch("https://fruitai-backend-gvpj.onrender.com/faqs");
  ...
  const handleConfirmDelete = async () => {
    try {
      const response = await fetch(
        `https://fruitai-backend-gvpj.onrender.com/faqs/${deleteId}`,
        { method: "DELETE" }
      );
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        `https://fruitai-backend-gvpj.onrender.com/faqs/${editItem.id}`,
        {
          method: "PUT",
          headers: {
